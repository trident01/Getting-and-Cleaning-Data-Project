...
#Same as above but with the test  
...
#Replace the numerical output values with descriptive strings for the activities
...
#Only look for mean and std. dev. values of feature-data
mergedData_mean_sd <- cbind(mergedData[,(grepl("mean()", features, fixed = TRUE) | grepl("std()", features, fixed = TRUE))])

#Calculate means across different subjects/activities
